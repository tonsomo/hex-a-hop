...
/*EMPTY*/
#ifndef _GP2X
"Basic controls:|Move around with Q,W,E,A,S,D or the numeric  keypad. Alternatively, you can use the mouse and  click on the tile you'd like to move to.    Use 'U', backspace or the right mouse button to  undo mistakes.    The 'Esc' key (or middle mouse button) brings up a  menu from which you can restart if you get stuck.",
#else
"Basic controls:|Move around with the stick. Use (Y) to undo mistakes.   The start button brings up a  menu from which you can restart if you get stuck.",
#endif
/*NORMAL*/
0,
/*COLLAPSABLE*/
...
#else
"You can bounce on the purple trampoline tiles to  get around.    But try not to fall in the water.    If you do, remember you can undo with 'Y'!",
#endif
/*SPINNER*/
